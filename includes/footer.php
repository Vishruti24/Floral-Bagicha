    ...
    <div class="footer__container container grid">
        <div class="footer__content">
            <a href="#" class="footer__logo">
                <i class="ri-leaf-line footer__logo-icon"></i> <?php echo SITE_NAME; ?>
            </a>
        ...
        <div class="footer__content">
            ...
            <div class="footer__cards">
                ...
                <img src="assets/card4.png" alt="" class="footer__card">
            </div>
        </div>
    </div>

    <p class="footer__copy">&#169; <?php echo date('Y'); ?> <?php echo SITE_NAME; ?>. All rigths reserved</p>
</footer>
